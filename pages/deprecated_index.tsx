  ...
  const submit = async (e?: React.FormEvent) => {
    ...
    try {
      if (options.liveProgress) {
        ...
        const resp = await fetch("/api/deprecated_generate-stream", {
          method: "POST",
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "18px auto", fontFamily: "Inter, system-ui, Arial" }}>
      ...
      <p style={{ marginTop: 0, color: "#475569" }}>
        Legacy/experimental page. Use the canonical pipeline at <Link href="/generation_pipeline">/generation_pipeline</Link>.
      </p>
